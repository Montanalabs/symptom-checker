...
- `symptom-checker_safe.eide` — the correct design.
- `symptom-checker_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
